...
public class Gra extends JPanel implements KeyListener, ActionListener, MouseListener {
...
//            g.drawString("Level: " +level,570, 40);
    ...
    public void mouseClicked(MouseEvent e) {
        System.out.println("u clicked the mouse");
    }

    @Override
    public void mousePressed(MouseEvent e) {
        System.out.println("u presseed the mouse");
    }

    @Override
    public void mouseReleased(MouseEvent e) {
        System.out.println("u released the mouse");
    }

    @Override
    public void mouseEntered(MouseEvent e) {
        System.out.println("u are in the zone");
    }

    @Override
    public void mouseExited(MouseEvent e) {
        System.out.println("u are out of the zone");
    }
}